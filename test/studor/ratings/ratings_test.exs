defmodule Studor.RatingsTest do
  use Studor.DataCase
  ...
  describe "ratings" do
    ...
    @valid_attrs %{date: "2010-04-17T14:00:00Z", description: "some description", stars: 42}
    @update_attrs %{date: "2011-05-18T15:01:01Z", description: "some updated description", stars: 43}
    ...
    test "create_rating/1 with valid data creates a rating" do
      ...
      assert rating.date == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
      assert rating.description == "some description"
    ...
    test "update_rating/2 with valid data updates the rating" do
      ...
      assert rating.date == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
      assert rating.description == "some updated description"
