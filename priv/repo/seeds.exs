...
#Tutoring Sessions
Repo.insert!(%TutoringSession{description: "I would like some help with recursion and accumulators", approved: true, tutor_id: 1, student_id: 1, time_block_id: 4, course_id: 1, subject_area_id: nil})
Repo.insert!(%TutoringSession{description: "I need general help with the course material", approved: false, tutor_id: 1, student_id: 2, time_block_id: 5, course_id: 1, subject_area_id: 1})
Repo.insert!(%TutoringSession{description: "Help me", approved: true, tutor_id: 1, student_id: 3, time_block_id: 7, course_id: nil, subject_area_id: 3})
Repo.insert!(%TutoringSession{description: "Please help me review for my Calculus exam", approved: true, tutor_id: 2, student_id: 3, time_block_id: 9, course_id: nil,subject_area_id:  9})
Repo.insert!(%TutoringSession{description: "I need general help with the Kinematics", approved: false, tutor_id: 3, student_id: 5, time_block_id: 11, course_id: nil, subject_area_id: 5})
Repo.insert!(%TutoringSession{description: "I would like to review my orgo homework answers", approved: true, tutor_id: 3, student_id: 1, time_block_id: 13, course_id: 6, subject_area_id: nil})
Repo.insert!(%TutoringSession{description: "I would like help reviewing the problems I got wrong on my last CS Fundamentals exam", approved: false, tutor_id: 4, student_id: 2, time_block_id: 15, course_id: 1, subject_area_id: nil})
Repo.insert!(%TutoringSession{description: "I would like on overview of the basic concepts", approved: true, tutor_id: 5, student_id: 3, time_block_id: 19, course_id: nil, subject_area_id: 6})
Repo.insert!(%TutoringSession{description: "I need help with my bio 1 homework", approved: true, tutor_id: 5, student_id: 5, time_block_id: 4, course_id: 8, subject_area_id: 6})
Repo.insert!(%TutoringSession{description: "I would like crit on my recent poster design", approved: false, tutor_id: 6, student_id: 5, time_block_id: 5, course_id: nil, subject_area_id: nil})
Repo.insert!(%TutoringSession{description: "Review my physics problems for my engineering class", approved: true, tutor_id: 7, student_id: 1, time_block_id: 7, course_id: 7, subject_area_id: nil})
Repo.insert!(%TutoringSession{description: "I would like some help on my paper for conceptual drawing", approved: true, tutor_id: 8, student_id: 2, time_block_id: 9, course_id: nil, subject_area_id: 18})
Repo.insert!(%TutoringSession{description: "I need some review with dynamic programming", approved: true, tutor_id: 9, student_id: 3, time_block_id: 11, course_id: nil, subject_area_id: 1})
Repo.insert!(%TutoringSession{description: "Review my schema design for my databse design class", approved: false, tutor_id: 9, student_id: 2, time_block_id: 13, course_id: 5, subject_area_id: 3})
