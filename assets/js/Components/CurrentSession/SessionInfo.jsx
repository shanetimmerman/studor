...
class CurrentMembers extends React.Component {
    ...
    render() {
        ...
        if (user.user_type == "TUTOR") {
            peer = new Peer(tid, { host: 'my-peer.herokuapp.com', port: 443, path: '/', secure: true, config: { 'iceServers': [{ url: 'stun:stun.l.google.com:19302'}] }, debug: 3 });
            other_id = sid;
        } else {
            peer = new Peer(sid, { host: 'my-peer.herokuapp.com', port: 443, path: '/', secure: true, config: { 'iceServers': [{ url: 'stun:stun.l.google.com:19302'}] }, debug: 3 });
            other_id = tid;
        }
